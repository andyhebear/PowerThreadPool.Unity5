...
namespace PowerThreadPool_Net20.Results
{
    ...
    /// <summary>
    /// 带类型参数的执行结果
    /// Execution result with type parameter
    /// </summary>
    public class ExecuteResult<T> : ExecuteResult
    {
        ...
        /// Constructor (success)
        /// </summary>
        public ExecuteResult(WorkID id, T result, DateTime startTime, DateTime endTime)
            : base(id, result, startTime, endTime)
        {
        }
        ...
        /// </summary>
        public ExecuteResult(WorkID id, Exception exception, DateTime startTime, DateTime endTime)
            : base(id, exception, startTime, endTime)
        {
        }
        ...
        /// </summary>
        public ExecuteResult(WorkID id, DateTime startTime, DateTime endTime, Exception timeoutException)
            : base(id, startTime, endTime, timeoutException)
        {
        }
    }
}